    ...
    <>
      ...
      <div className="w-1/2">
        <div className="relative rounded-xl">
          <img
            src="https://www.finereport.com/en/wp-content/uploads/2020/03/01-1.gif"
            alt="Hero Image"
            className="hidden w-full rounded-[inherit] object-contain shadow-lg dark:block"
          />
          <img
            src="https://www.finereport.com/en/wp-content/uploads/2020/03/01-1.gif"
            alt="Hero Image"
            className="block w-full rounded-[inherit] object-contain shadow-lg dark:hidden"
          />

          <BorderBeam size={150} duration={12} delay={9} borderWidth={5} />
        </div>
      </div>
